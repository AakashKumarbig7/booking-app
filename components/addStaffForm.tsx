...
//     // Delete employee
//     const { error } = await supabase.from("users").delete().eq("id", selectedEmployee.employee_id)
...
//             <div
//               className="bg-blue-700 text-white rounded-[12px] w-[130px] h-[40px] flex items-center justify-center text-xs cursor-pointer"
...
//           {/* Footer: Save & Cancel */}
//           <div className="mt-3 pt-3 flex justify-end gap-2 px-3 pb-2">
