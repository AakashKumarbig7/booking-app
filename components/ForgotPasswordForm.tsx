    ...
    <div className="w-full h-full overflow-hidden hidden md:flex">
      ...
      <div className="w-1/2 flex items-center justify-center p-6">
        ...
        >
          ...
          />
          <button type="submit" className="bg-teal-800 text-[white] text-sm px-4 py-2 border border-[#1A80F4] rounded mb-2 hover:bg-teal-700">
            Confirm
          </button>
          {message && (
          ...
          <Link
            href="/login"
            className="rounded-md no-underline text-sm text-center mt-4 text-teal-800"
          >
             Sign in
          </Link></span></p>
        </form>
